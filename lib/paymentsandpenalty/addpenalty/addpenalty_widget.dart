...
import 'addpenalty_model.dart';
export 'addpenalty_model.dart';

class AddpenaltyWidget extends StatefulWidget {
  const AddpenaltyWidget({super.key});

  @override
  State<AddpenaltyWidget> createState() => _AddpenaltyWidgetState();
}

class _AddpenaltyWidgetState extends State<AddpenaltyWidget> {
  late AddpenaltyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddpenaltyModel());
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<List<DriversRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<DriversRow>
                                            dropDownDriversRowList =
                                            snapshot.data!;
                                        return FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .dropDownValueController ??=
                                              FormFieldController<String>(null),
                                          options: dropDownDriversRowList
                                              .map((e) => e.name)
                                              .withoutNulls
                                              .toList(),
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        await DriverpenaltyTable().insert({

...
class _PaymentsWidgetState extends State<PaymentsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.recentpayments = await DriverpaymentTable().queryRows(
        queryFn: (q) => q,
      );
    });
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                final recentpaymentssupa =
                                    (_model.recentpayments?.toList() ?? [])
                                        .take(6)
                                        .toList();
                                return FlutterFlowDataTable<DriverpaymentRow>(
                                  controller:
                                      _model.paginatedDataTableController,
                                  data: recentpaymentssupa,
                                  ...
                                  dataRowBuilder: (recentpaymentssupaItem,
                                          recentpaymentssupaIndex,
                                          selected,
                                          onSelectChanged) =>
                                      DataRow(
                                    color: MaterialStateProperty.all(
                                      recentpaymentssupaIndex % 2 == 0
                                          ? FlutterFlowTheme.of(context)
                                              .secondaryBackground
                                          : FlutterFlowTheme.of(context)
                                              .primaryBackground,
                                    ...
                                    cells: [
                                      FutureBuilder<List<DriversRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<DriversRow> textDriversRowList =
                                              snapshot.data!;
                                          final textDriversRow =
                                              textDriversRowList.isNotEmpty
                                                  ? textDriversRowList.first
                                                  : null;
                                          return Text(
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          recentpaymentssupaItem.finalamount
                                              ?.toString(),
                                          'time',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          recentpaymentssupaItem.totalkm,
                                          'amount',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          recentpaymentssupaItem.totalorders
                                              ?.toString(),
                                          'reason',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          recentpaymentssupaItem.penalty
                                              ?.toString(),
                                          'penalty',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          recentpaymentssupaItem.paymentstatus,
                                          'status',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium

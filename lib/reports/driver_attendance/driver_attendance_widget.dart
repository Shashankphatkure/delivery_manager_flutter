...
import 'driver_attendance_model.dart';
export 'driver_attendance_model.dart';

class DriverAttendanceWidget extends StatefulWidget {
  const DriverAttendanceWidget({super.key});

  @override
  State<DriverAttendanceWidget> createState() => _DriverAttendanceWidgetState();
}

class _DriverAttendanceWidgetState extends State<DriverAttendanceWidget> {
  late DriverAttendanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverAttendanceModel());

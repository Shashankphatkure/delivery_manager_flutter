  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<OrderRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrderRow> orderDetailsOrderRowList = snapshot.data!;
        final orderDetailsOrderRow = orderDetailsOrderRowList.isNotEmpty
            ? orderDetailsOrderRowList.first
            : null;
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        'Order ${valueOrDefault<String>(
                                          orderDetailsOrderRow?.id.toString(),
                                          'id',
                                        )}',
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                            ...
                                            child: Padding(
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<CustomersRow>
                                                      desktopVersionCustomersRowList =
                                                      snapshot.data!;
                                                  final desktopVersionCustomersRow =
                                                      desktopVersionCustomersRowList
                                                              .isNotEmpty
                                                          ? desktopVersionCustomersRowList
                                                              .first
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                desktopVersionCustomersRow?.name,
                                                                                'name',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyLarge.override(
                                                                                    fontFamily: 'Plus Jakarta Sans',
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  desktopVersionCustomersRow?.phone?.toString(),
                                                                                  'phone',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                      fontFamily: 'Plus Jakarta Sans',
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              if (isiOS) {
                                                                await launchUrl(
                                                                    Uri.parse(
                                                                        "sms:${valueOrDefault<String>(
                                                                  desktopVersionCustomersRow
                                                                      ?.phone
                                                                      ?.toString(),
                                                                  'phone',
                                                                )}&body=${Uri.encodeComponent('this message is sent from manager panel')}"));
                                                              } else {
                                                                await launchUrl(
                                                                    Uri(
                                                                  scheme: 'sms',
                                                                  ...
                                                                  queryParameters: <String,
                                                                      String>{
                                                                    'body':
                                                                        'this message is sent from manager panel',
                                                                  },
                                                                ));
                                                              }
                                                            },

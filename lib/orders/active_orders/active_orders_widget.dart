...
import 'active_orders_model.dart';
export 'active_orders_model.dart';
...
class _ActiveOrdersWidgetState extends State<ActiveOrdersWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActiveOrdersModel());
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              context.pushNamed('ActiveOrders');
                                            },
                                            child: Container(
                                              height: 32.0,
                                              decoration: BoxDecoration(
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              context
                                                  .pushNamed('Completedorders');
                                            },
                                            child: Container(
                                              height: 32.0,
                                              decoration: BoxDecoration(
                                                color: const Color(0xFFD6F2BF),
                                                borderRadius:
                                                    BorderRadius.circular(8.0),
                                              ),
                                              alignment: const AlignmentDirectional(

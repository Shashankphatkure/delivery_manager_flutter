...
class ExpiringSubscriptionsTable
    extends SupabaseTable<ExpiringSubscriptionsRow> {
  @override
  String get tableName => 'expiring_subscriptions';

  @override
  ExpiringSubscriptionsRow createRow(Map<String, dynamic> data) =>
      ExpiringSubscriptionsRow(data);
}

class ExpiringSubscriptionsRow extends SupabaseDataRow {
  ExpiringSubscriptionsRow(super.data);

  @override
  SupabaseTable get table => ExpiringSubscriptionsTable();

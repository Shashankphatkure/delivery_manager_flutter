...
class CustomersthismonthTable extends SupabaseTable<CustomersthismonthRow> {
  @override
  String get tableName => 'customersthismonth';

  @override
  CustomersthismonthRow createRow(Map<String, dynamic> data) =>
      CustomersthismonthRow(data);
}

class CustomersthismonthRow extends SupabaseDataRow {
  CustomersthismonthRow(super.data);

  @override
  SupabaseTable get table => CustomersthismonthTable();

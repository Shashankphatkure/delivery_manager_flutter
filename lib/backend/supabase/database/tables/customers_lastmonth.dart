...
class CustomersLastmonthTable extends SupabaseTable<CustomersLastmonthRow> {
  @override
  String get tableName => 'customers_lastmonth';

  @override
  CustomersLastmonthRow createRow(Map<String, dynamic> data) =>
      CustomersLastmonthRow(data);
}

class CustomersLastmonthRow extends SupabaseDataRow {
  CustomersLastmonthRow(super.data);

  @override
  SupabaseTable get table => CustomersLastmonthTable();

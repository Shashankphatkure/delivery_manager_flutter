...
class DeliveryManagerSupabaseUser extends BaseAuthUser {
  DeliveryManagerSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> deliveryManagerSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = DeliveryManagerSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}

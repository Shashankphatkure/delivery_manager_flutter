...
class _AddmanagerWidgetState extends State<AddmanagerWidget> {
  ...
  void initState() {
    ...
    _model.aadharCardTextController ??= TextEditingController();
    _model.aadharCardFocusNode ??= FocusNode();
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller:
                                          _model.aadharCardTextController,
                                      focusNode: _model.aadharCardFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Label here...',
                                      ...
                                      keyboardType: TextInputType.phone,
                                      validator: _model
                                          .aadharCardTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [
                                        FilteringTextInputFormatter.allow(
                                            RegExp('[0-9]'))
